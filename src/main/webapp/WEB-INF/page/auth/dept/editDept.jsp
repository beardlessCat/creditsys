	...
	<div data-options="region:'west',border:true" class="easyui-panel" style="width:100%;padding:30px 60px">	
 				<table id="deptList"  >
	  				<tr>
						...
						<td class="form-control">			
							<select id="deptParentId"  class="easyui-combotree"   data-options="required:true"  style="width:300px;height:30px"></select>
						</td>
					</tr>
					<tr >
...
<script type="text/javascript">
  	...
  	function doInit(dialog){
  		...
  		$('#deptName').textbox('setValue',selected.deptName);
  		$('#deptParentId').combotree('setValue',selected.deptParentId);
  	 	$('#deptLevel').textbox('setValue',selected.deptLevel);
  	 	$('#deptOrder').textbox('setValue',selected.deptOrder);
  	 	$('#deptIsValid').combobox('setValue',selected.deptIsValid);
  		$('#deptLeader').textbox('setValue',selected.deptLeader);
